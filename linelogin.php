...
class linelogin {
    ...
    private const CLIENT_ID = NULL;
    private const CLIENT_SECRET = NULL;

    // CHANGEME: Default Callback redirect link
    private const REDIRECT_URL = NULL;
    ...
    function getLink($scope) {
        ...
        $link = self::AUTH_URL . '?response_type=code&client_id=' . self::CLIENT_ID . '&redirect_uri=' . self::REDIRECT_URL . '&scope=' . $this->scope($scope) .'&state=' . $_SESSION['state'];
        return $link;
    }
